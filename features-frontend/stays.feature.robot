...
Scenario: Attempt to enter less than 1 adult
    [Documentation]    Verify that the system does not alDEV the number of adults to 
     ...    drop beDEV 1, and the '-' button is appropriately disabled 
    [Tags]    DEV
...
Scenario: Attempt to enter more than 1 adult
    [Documentation]    
     ...    Verify that the system alDEVs increasing the number of adults and ensures the 
