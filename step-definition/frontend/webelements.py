...
LIST_DESTINATIONS="//ul[@class='d-1ip0gkj']/li"
...
ROUND_TRIP_RETURN_DATE="//span[contains(@class,'Lalvx')]"
LIST_OF_HOTELS="css=a[data-testid='details']"
RANDOM_HOTELS="css=.sc-cd507511-0:nth-child(xx)"
ALL_FILTERS_BTN="//button[contains(@class,'Pill-AllFiltersContainer')]"
FILTERS_DISPLAY="//div[@class='sc-4b308c31-0 eXdSrn']"
FILTERS_HEADER="//div[contains(@class,'openx-ui-modal-filters')]/div[@data-testid='container-controls']/div[1]"
FLASH_SALES_BTN="//label[@id='ck_label_flash_sales']/div[2]"
MIN_VALUE="css=.MuiDialogContent-root .sc-2debd093-1:nth-child(1)"
MAX_VALUE="css=.MuiDialogContent-root .sc-2debd093-1:nth-child(2)"
MIN_MAX_BAR="css=.MuiDialogContent-root .Slider__SliderTrack-sc-lsb7pl-4.eWzYjO"
MIN_DRAG_BTN="css=.MuiDialogContent-root span:nth-child(2) > .Slider__SliderThumb-sc-lsb7pl-6"
DRAG_BTN="css=.MuiDialogContent-root .Slider__SliderRoot-sc-lsb7pl-7 > span:nth-of-type(2) > .Slider__SliderThumb-sc-lsb7pl-6.chzwcA"
SELECT_STARS="css=.MuiDialogContent-root #exp_elem_hotel_stars_5 rect"
RANDOM_ONLY_BTN="css=.MuiDialogContent-root .sc-bb0192c8-2:nth-child(2) > .sc-213e9052-0"
APPLY_BTN="//div[@class='sc-efd5badf-0 jCbEWB']"
