...
ROUND_TRIP_CALENDAR_BUTTON="(//button[contains(@class,'lMwQM')])[3]"
ROUND_TRIP_CALENDER_DETAIL="(//h3[contains(@class,'-P79c')])"
ROUND_TRIP_SELECT_DATE="(//span[@tabindex='0'])[2]"
ROUND_TRIP_RETURN_DATE="//span[contains(@class,'3aEol')]"
LIST_OF_HOTELS="//div[@data-testid='card-container']"
